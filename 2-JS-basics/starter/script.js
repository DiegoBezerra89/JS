...
//array loop
var john = ['John', 'Smith', 29, 'single', 'Teacher'];
...
for(var i = john.length - 1; i >= 0; i--) {
    if(typeof john[i] !== 'string' ) continue; //this jumps the condition, and continues the loop
    console.log(john[i]);
}

var john = ['John', 'Smith', 29, 'single', 'Teacher'];
for(var i = john.length - 1; i >= 0 ; i--) {
    if(typeof john[i] !== 'string' ) break; //this jumps the condition, and ends the loop
    console.log(john[i]);
}
*/
...
var john = {
    ...
    calculateTip: function(){
        ...
        for(var i = 0; i < this.values.length; i++){
            ...
            this.tip[i] = percentage * this.values[i];
            this.totalValue[i] = this.tip[i] + this.values[i];
        }
    }
}
